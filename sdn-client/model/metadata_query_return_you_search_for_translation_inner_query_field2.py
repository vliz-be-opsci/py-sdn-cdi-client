...
class MetadataQueryReturnYouSearchForTranslationInnerQueryField2(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MetadataQueryReturnYouSearchForTranslationInnerQueryField2 - a model defined in OpenAPI
